    ...
    if response.status_code == 200:
        ...
        if 'foods' in data:
            ...
            return {
                ...
                "Sweetness (g)": nutrition.get('nf_sugars')or 20,
    ...
    if st.button("✨ Analyze Food"):
        if image:
            ...
            if nutrition:
                ...
                # ✅ NEW: Generate meal suggestions based on prompt
                if input_text.strip():
                ...
                st.error("⚠️ Could not fetch nutrition information. Try another image or more specific name.")
